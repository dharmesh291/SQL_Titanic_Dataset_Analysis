...
select name,survived from titanic where survived!='survived' and pclass=3;
...
select name,survived,age,Embarked from titanic where survived='survived' and Embarked='s';
...
select name,age,survived from titanic where survived!='survived' and pclass=1;
...
select name from titanic where survived='survived' and age>20 and pclass=3; 
